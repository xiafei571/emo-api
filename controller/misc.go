...
func buildEmailVerificationMessage(systemName, code string, validMinutes int) (string, string) {
	...
	content := fmt.Sprintf("<p>Hello,</p>"+
		"<p>Use the following verification code to verify your email address for %s:</p>"+
		"<p><strong>%s</strong></p>"+
		"<p>This code expires in %d minutes. If you did not request it, you can safely ignore this email.</p>",
		escapedSystemName, escapedCode, validMinutes)
...
func buildPasswordResetMessage(systemName, link string, validMinutes int) (string, string) {
	...
	content := fmt.Sprintf("<p>Hello,</p>"+
		"<p>We received a request to reset your password for %s.</p>"+
		"<p><a href=\"%s\">Reset your password</a></p>"+
		"<p>If the link does not work, copy and paste this URL into your browser:</p>"+
		"<p>%s</p>"+
		"<p>This link expires in %d minutes. If you did not request a password reset, you can safely ignore this email.</p>",
		escapedSystemName, escapedLink, escapedLink, validMinutes)
	return subject, content
}
